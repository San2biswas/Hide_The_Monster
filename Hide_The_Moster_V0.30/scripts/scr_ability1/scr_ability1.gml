...
if global.run == 1 && key_q
{
	...
	{
		layer_set_visible("motionEffect1", 1);
	}
	if key_up || key_down
	{
		layer_set_visible("motionEffect2", 1);
	}
...
if abilityTimer == 0
{
	...
	layer_set_visible("motionEffect1", 0);
	layer_set_visible("motionEffect2", 0);
	if global.visionToggle == 1 image_blend = make_color_rgb(80, 255, 120);
